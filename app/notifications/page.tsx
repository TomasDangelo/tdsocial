                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        ...
                        {notification.type === "FOLLOW" ? "empezó a seguirte" : notification.type === "LIKE" ? "le dio like a tu publicación"
                        ...
                        <div className="pl-6 space-y-2">
                          <div className="text-sm text-muted-foreground rounded-md p-2 bg-muted/30 mt-2">
                            ...
                            {notification.post.image && (
                              <img src={notification.post.image} alt="Post content" className="mt-2 rounded-md w-full max-w-[200px] h-auto object-cover"/>
                            )}
                          </div>
